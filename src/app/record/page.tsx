...
const mockRecords: HistoryRecord[] = [
  // — 今天 4/10 —
  {
    ...
    fullText: "拍照記錄午餐：一碗魚湯、一碟燙地瓜葉、半碗白飯。今天胃口不錯，全部吃完。",
    originalFile: "IMG_1023.jpg",
    imageUrl: "/mock-meal-photo.jpg",
  },
  {
    id: "2", date: "今天 4/10", time: "09:12", category: "用藥", tags: ["飲食"], source: "voice",
    recordedBy: "阿偉（兒子）",
    preview: "早餐後服用降血壓藥一顆，血糖藥一顆",
    fullText: "早上八點有吃降血壓藥一顆，飯後血糖藥一顆。吃完藥之後精神還不錯，有稍微散步十分鐘。早餐吃了半碗粥跟一顆蛋。",
  ...
  },
  {
    ...
    fullText: "早上量測：血壓 138/82 mmHg，心率 72 bpm，體溫 36.4°C。數值穩定。",
  },
  // — 昨天 4/9 —
  {
    ...
    fullText: "晚上八點半左右反映有輕微頭暈的感覺，讓她坐下休息，大概十分鐘後好轉。情緒稍微有點不安，安慰後恢復。量血壓偏高 152/90。",
  ...
  },
  {
    ...
    fullText: "下午五點多開始情緒比較低落，不太願意講話，問什麼都搖頭。六點左右讓她聽喜歡的台語歌之後好一些，晚餐有吃一點東西。",
  },
  {
    id: "6", date: "昨天 4/9", time: "12:15", category: "飲食", tags: [], source: "text",
    recordedBy: "美玲（女兒）",
    preview: "午餐吃了半碗稀飯、一碟青菜，食慾尚可",
    fullText: "午餐吃了半碗稀飯、一碟燙青菜、一小塊蒸魚。食慾尚可，比前天好一些。喝了約 200ml 的水。",
  },
  {
    id: "7", date: "昨天 4/9", time: "12:20", category: "飲食", tags: [], source: "upload",
    recordedBy: "居服員 小陳",
    preview: "午餐照片 — 稀飯、青菜、蒸魚",
    fullText: "拍照記錄午餐內容：半碗稀飯、一碟燙青菜、一小塊蒸魚。食慾比前天好一些。",
  ...
  },
  {
    ...
    fullText: "早餐吃了一碗粥配肉鬆。八點十分服用降血壓藥一顆、血糖藥一顆。觀察半小時無異常。",
  ...
  // — 4/7 —
  {
    ...
    fullText: "處方箋內容：Amlodipine 5mg→10mg 調高劑量，Metformin 500mg 維持不變。醫師指示下次回診觀察血壓變化。",
  ...
  },
  {
    ...
    fullText: "回診前在家量血壓 148/88 mmHg，心率 78 bpm。醫師看過後決定調高降壓藥劑量。",
  },
  {
    id: "14", date: "4/7（一）", time: "07:50", category: "飲食", tags: [], source: "voice",
    recordedBy: "阿偉（兒子）",
    preview: "早餐吃了一碗燕麥粥，胃口還行",
    fullText: "早餐吃了一碗燕麥粥加一點蜂蜜，配半顆水煮蛋。說味道還可以，但不是很餓。喝了一小杯溫豆漿。",
